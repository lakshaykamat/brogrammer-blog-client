...
const CategoryPage = ({ params }: { params: { categoryId: string } }) => {
  ...
  const blogCards = CATEGORIES.data ? (
  ...
  return (
    <div className="m-12 xl:mx-48">
      ...
      <p className="my-3">
        Each category focuses on a specific area, offering in-depth articles and
        resources to help you stay informed and enhance your skills.{" "}
      </p>
      <hr className="mb-3" />
